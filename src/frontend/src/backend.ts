...
export class Backend implements backendInterface {
    ...
    async savePhoto(arg0: string, arg1: ExternalBlob, arg2: bigint): Promise<Photo> {
        if (this.processError) {
            try {
                const result = await this.actor.savePhoto(arg0, await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg1), arg2);
